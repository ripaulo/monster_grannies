...
user1 = User.create(email: Faker::Internet.email, password: "123456", first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, location: 'Lisboa', birth_date: Date.new(1948,2,3), granny:true, description:"Super awesome, burlesque granny!", price: 19.4 )
...
user3 = User.create(email: Faker::Internet.email, password: "123456", first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, location: 'Lisboa', birth_date: Date.new(1954,2,3), granny:true, description:"Have a great ride with this taxi driver granny" , price: 34.00)
...
user5 = User.create(email: Faker::Internet.email, password: "123456", first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, location: 'Lisboa', birth_date: Date.new(1955,2,3), granny:true, description:"Bored to death? Have a ball with drag queen granny Strawberry Shortcake", price: 56.57)
